...
//    public static double ITD = 0;
    ...
    public static double HP = -.05;
    public static double HD = -0.001;
    public static double HF = -0.38;
    ...
    public static double ShooterP = 0.009;
    ...
    public static  double Kdd = -6;
    public static double Kfd = -0.15;
