...
public class GoodBNO055 {
    ...
    public GoodBNO055(String deviceName) {

        imu = BaseOpMode.getHardwareMap().get(BNO055IMU.class,deviceName);
    ...
    public double getAngle(){
        ...
        BaseOpMode.addData(" raw anlge", currentAngle);
        BaseOpMode.addData("delta angle", deltaAngle);
        BaseOpMode.addData("datum", datum);
