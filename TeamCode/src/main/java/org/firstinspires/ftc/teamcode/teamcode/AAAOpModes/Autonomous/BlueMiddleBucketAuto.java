...
@Autonomous(name = "BLUEMIDDLEBucketAuto")
@Disabled
public class BlueMiddleBucketAuto extends BaseOpMode {
    ...
    public void score2() {
        ...
        else {drive.holdPosition(5.2, 119, 1.43, .6);}
    ...
    public void submersible(){
        ...
        if (timeWaste.seconds() < 2) {
            drive.holdPosition(70, 110, 0, 1);
        } else {
            drive.holdPosition(70, 92,0, .6);
        }
        ...
        if (intake.getIntakeColor() == MainIntake.SampleColor.RED || timeWaste.seconds() > 7) {
