...
public class Controller {
	...
	public Button cross, circle, triangle, square, dpad_up, dpad_down, dpad_left, dpad_right, rightBumper, leftBumper, rightTrigger, leftTrigger, share, touchpad, options, playstation;
	...
	public Controller(Gamepad gamepad) {
		...
		share = new Button(); touchpad = new Button(); playstation = new Button();
	...
	public void update(){
		...
		rightTrigger.update(gamepad.right_trigger); leftTrigger.update(gamepad.left_trigger); playstation.update(gamepad.ps);
