...
public class DimitriTeleop extends BaseOpMode{
    ...
    public void externalInit() {
        ...
        Constants.team = (Constants.Team) blackboard.getOrDefault("Team", Constants.Team.RED);
        shooter = new Shooter(hardwareMap, Constants.team);
        ...
        Vector startPos = (Vector) blackboard.getOrDefault("AutoEndPos",new Vector(341,341,Math.PI/2));
    ...
    public void externalLoop() {
        ...
        if (driver1.options.isTapped()){
            loc.setPosition(341,341,Math.PI/2);
        }
        ...
        if (driver1.leftTrigger.isPressed()){
            ...
            intake.setState(IntakeMagazine.IntakeMagazineStates.CLEARFRONT);
            wasIntaking = true;
        } else if (driver1.leftBumper.isPressed()){
            intake.setState(IntakeMagazine.IntakeMagazineStates.CLEARREAR);
            wasIntaking = true;
